...
ErrorStatus UB_Touch_Init(void)
{
  ...
  FT5336_TOUCH_REG[0][0]=FT5336_P1_XL_REG;  /* regAddressXLow */
  FT5336_TOUCH_REG[0][1]=FT5336_P1_XH_REG;  /* regAddressXHigh */
  FT5336_TOUCH_REG[0][2]=FT5336_P1_YL_REG;  /* regAddressYLow */
  FT5336_TOUCH_REG[0][3]=FT5336_P1_YH_REG;  /* regAddressYHigh */
